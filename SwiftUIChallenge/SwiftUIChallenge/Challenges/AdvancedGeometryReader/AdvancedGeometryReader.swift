...
struct AdvancedGeometryReader: View {
    var body: some View {
        HStack {
            Text("SwiftUI")
...
struct AdvancedGeometryReader_Previews: PreviewProvider {
    static var previews: some View {
        AdvancedGeometryReader()
    }
}
